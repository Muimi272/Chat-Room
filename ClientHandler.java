...
public class ClientHandler extends Thread {
    ...
    private CopyOnWriteArrayList<OutputStream> osl;
    private OutputStream myOutputStream;
    private CopyOnWriteArrayList<String> allMemberNames;
    ...
    private String[] handleContent(StringBuilder sb) {
        ...
        switch (title) {
            ...
            case "join:":
                ...
                return new String[]{"join", introduce};
            case "away:":
                String leave = request.substring(5);
                return new String[]{"away", leave};
            default:
                return new String[]{"null", "null"};
        }
    }
    ...
    private void cleanup() {
        if (myOutputStream != null && osl.contains(myOutputStream)) {
